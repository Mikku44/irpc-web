        ...
        if (!mapboxgl.supported()) {
            ...
            if (mapContainerRef.current) {
                ...
                for (const marker of data) {
                    ...
                    elChild.innerHTML = (marker.LastUpdate?.AQI?.aqi || marker.LastUpdate?.COD || marker.LastUpdate?.Flow || marker.LastUpdate5min?.Leq || marker.LastUpdate?.fire || "-") ;
                    ...
                    `<div style="display: grid;">
                        <div style="display: flex; justify-content: space-between;">
                            <div style="font-size: 1.25rem; font-weight:bold;">
                                ${marker.LastUpdate?.AQI?.aqi || marker.LastUpdate?.COD || marker.LastUpdate?.Flow || marker.LastUpdate5min?.Leq || marker.LastUpdate?.fire || "N/A"} 
