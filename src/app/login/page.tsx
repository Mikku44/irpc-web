                    ...
                    <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
                        <form>
                            <div className="mb-4">
                                ...
                                <Input className="p-3" placeholder="กรอกอีเมลของคุณ" />
                            </div>
                            <div className="mb-4">
                                ...
                                <Input.Password className="p-3" placeholder="รหัสผ่าน" />
                            </div>
                        ...
                        <div className="text-center mt-6 ">
                            <p className="text-gray-600"> ยังไม่มีบัญชีผู้ใช้? <a href="#" className="text-blue-500 font-bold">ลงทะเบียน</a></p>
                        </div>
                    </div>
                </div>
            </div>
